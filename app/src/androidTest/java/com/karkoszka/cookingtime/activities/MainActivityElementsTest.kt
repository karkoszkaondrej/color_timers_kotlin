...
class MainActivityElementsTest {
    ...
    fun mainActivityElementsTest() {
        ...
        val chronometer = onView(
            allOf(
                withId(R.id.chronometer1), withContentDescription("0 seconds"),
                childAtPosition(
                    allOf(
                        withId(R.id.linear1),
                        childAtPosition(
        ...
        val chronometer2 = onView(
            allOf(
                withId(R.id.chronometer2), withContentDescription("0 seconds"),
                childAtPosition(
                    allOf(
                        withId(R.id.linear2),
                        childAtPosition(
        ...
        val chronometer3 = onView(
            allOf(
                withId(R.id.chronometer3), withContentDescription("0 seconds"),
                childAtPosition(
                    allOf(
                        withId(R.id.linear3),
                        childAtPosition(
        ...
        val chronometer4 = onView(
            allOf(
                withId(R.id.chronometer4), withContentDescription("0 seconds"),
                childAtPosition(
                    allOf(
                        withId(R.id.linear4),
                        childAtPosition(
        ...
        val chronometer5 = onView(
            allOf(
                withId(R.id.chronometer5), withContentDescription("0 seconds"),
                childAtPosition(
                    allOf(
                        withId(R.id.linear5),
                        childAtPosition(
        ...
        val chronometer6 = onView(
            allOf(
                withId(R.id.chronometer6), withContentDescription("0 seconds"),
                childAtPosition(
                    allOf(
                        withId(R.id.linear6),
                        childAtPosition(
