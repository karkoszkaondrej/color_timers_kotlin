...
class SwipeMinutesTest {
    ...
    fun swipeTest() {
        ...
        onView(withId(R.id.linearSplitSetTime)).perform(swipeRight())

        val textView = onView(
                allOf(withId(R.id.dynamicTextMinutes),
                        withParent(allOf(withId(R.id.infoPanel),
    ...
    fun swipeRight(): ViewAction? {
        return GeneralSwipeAction(Swipe.FAST, GeneralLocation.CENTER_LEFT,
